...
#ifndef LIBRE_NES_CPU_ADDRESSING_H
#define LIBRE_NES_CPU_ADDRESSING_H

// Addressing mode logic for the 6502-like CPU. Addressing modes can be
// understood as hardware-level polymorphism: they enable the same operation to
// take different kinds of arguments. The main purpose of this module is to
// decouple the execution of each operation from the exact addressing mode that
// it is using.
...
#endif // LIBRE_NES_CPU_ADDRESSING_H
